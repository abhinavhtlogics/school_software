...
class QulaificationList extends Component {
  constructor() {
    super();
    this.state = {
      showError: false,
  ...
  componentDidMount() {
    ...
    axios.get(`http://127.0.0.1:8000/api/get_qualification`)  
    .then(res => {  
     console.log(res.data);
     if(res.data.status == "successed"){
        this.setState({ qualificationList:res.data.data});
              ...
              <div className="row page-titles mx-0">
                ...
                <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                  <ol className="breadcrumb breadcrumb-btn">
                    <li><a href="/create_qualification" className="btn bg-blue-soft text-blue"><i className="fa fa-user-plus" /> Add New Qualifiaction</a></li>
                  </ol>
                </div>
              </div>
              {/* row */}
...
export default QulaificationList;
