...
class CreateQualification extends Component {
  ...
  axios.post('/add_qualification', data)
    .then(response => {
			...
			<div className="row page-titles mx-0">
				...
				<div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
					<ol className="breadcrumb">  						
						<li><a href={`/qualification_list`} className="btn bg-blue-soft text-blue"><i className="fa fa-angle-double-left"></i> Back to Qualifiaction List</a></li>	  
					</ol>
				</div>
			</div>
					  ...
					  <form onSubmit={this.handleCreateNewItem}>   
						<div className="form-row">
						  <div className="form-group col-md-6">
							...
							<input type="text" className={`form-control ${this.hasErrorFor('qualification') ? 'is-invalid' : ''}`} id="name" name="name" ref={this.input} placeholder="Enter Qualification"/>
									{this.renderErrorFor('qualification')}  </div>
