...
class DesignationList extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(`http://127.0.0.1:8000/api/get_designation`)  
    .then(res => {  
     console.log(res.data);
     if(res.data.status == "successed"){
        this.setState({ designationList:res.data.data});
              ...
              <div className="row page-titles mx-0">
                ...
                <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                  <ol className="breadcrumb breadcrumb-btn">
                    <li><a href="/create_designation" className="btn bg-blue-soft text-blue"><i className="fa fa-user-plus" /> Add New Designation</a></li>
                  </ol>
                </div>
              </div>
              {/* row */}
                      ...
                      <div className="table-responsive">
                        <table className="table table-bordered table-striped verticle-middle table-responsive-sm" id="example">
                          ...
                          <tbody>
                            ...
                            {this.state.designationList.map( (item, key) => {
                                return (
                            <tr>
