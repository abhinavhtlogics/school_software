...
class QualificationController extends Controller		
{
	...
	{ 
        ...
        if(!empty($qualification)) {   
			return response()->json(["status" => 'successed',"data" => $qualification]);    	  	
		}
		else {
	...
	public function create(Request $request)			
	{
		...
		$validator = Validator::make($request->all(), [
            'qualification' => 'required|unique:qualification_master,qualification'
        ]);
		...
		else
		{
			...
			$inserts=Qualification::insert($insert_arr);  
