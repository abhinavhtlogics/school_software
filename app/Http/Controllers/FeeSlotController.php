...
class FeeSlotController extends Controller
{
	...
	public function create(Request $request)			
	{
		...
		if(count($months)==0)
		{
			return response()->json(["status" => "failed", "message" => "Please select checkbox!!","errors" =>'']);  
		}
		else  
		{
			...
			return response()->json(["status" =>'successed', "success" => true, "message" => "fee slot record added successfully","data" =>$slot]);    
		}
